      ...
      <v-content>
        ...
        <section style="background:#ffffff" id="about-me">
          ...
          <v-container  class="text-center less-margin">
            <h2 class="display-2 black-text font-weight-bold mb-3">PROJECTS</h2>
                ...
                <v-col class="cv-text middle" cols="12" md='4' :key='i'>   
                  <v-card class="mx-auto" link target="_blank" :href="p.link" >
                    <v-img
                      ...
                      gradient="to bottom, rgba(100,115,201,.0), rgba(25,32,72,.3)"
                      :src="p.img"
                    >
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      db.getProjects('').then(function(snapshot) {
